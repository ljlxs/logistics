...
import { ref } from 'vue'
import {
    LeftTopEcharts, LeftContEcharts,
    RightTopEcharts
...
const text = ref("")
  var allData = {
        citys: [
          ...
          {
            name: "黑龙江",lineStyle: { normal: { color: "#9388ff" } },
        ...
        moveLines: [
          {
            fromName: "黑龙江",lineStyle: { normal: { color: "#9388ff" } },
            toName: "珠海",
            coords: [
              [126.661669, 45.742347],
              [113.576726, 22.270715],
            ],
            lineStyle: { normal: { color: "#fdcc26" } },
          },
          {
            fromName: "黑龙江",lineStyle: { normal: { color: "#9388ff" } },
            toName: "舒兰",
          ...
          {
            fromName: "吉林",lineStyle: { normal: { color: "#fdcc26" } },
            toName: "抚顺",
            coords: [
          ...
          {
            fromName: "黑龙江",lineStyle: { normal: { color: "#9388ff" } },
            toName: "吉林",lineStyle: { normal: { color: "#fdcc26" } },
            coords: [
              [126.661669, 45.742347],
              [126.549572, 43.837883],
            ],
          ...
          {
            fromName: "吉林",lineStyle: { normal: { color: "#fdcc26" } },lineStyle: { normal: { color: "#fdcc26" } },
            toName: "南通",
            coords: [
              [126.549572, 43.837883],
...
.realtime{
    display: grid;
    grid-template-columns:2fr 1fr;/* 设置列和行的尺寸。 */
